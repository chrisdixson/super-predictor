...
def team_info(element, result):
    ...
    # teams_info = [div for div in divs if div.has_attr('class') and div['class'][0].startswith('ci-team-score')]
    #print(element)
    #print(teams_info)
    if result == 'RESULT':
...
game_df("https://www.espncricinfo.com/series/asia-cup-2018-1153237/afghanistan-vs-india-5th-match-super-four-1153253/full-scorecard")
